 ...
 */
final class Version20220125095730 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_ABB64CD39D32F035');
        $this->addSql('DROP INDEX IDX_ABB64CD3933FE08C');
        $this->addSql('CREATE TEMPORARY TABLE __temp__ingredient_action AS SELECT ingredient_id, action_id FROM ingredient_action');
        $this->addSql('DROP TABLE ingredient_action');
        $this->addSql('CREATE TABLE ingredient_action (ingredient_id INTEGER NOT NULL, action_id INTEGER NOT NULL, PRIMARY KEY(ingredient_id, action_id), CONSTRAINT FK_ABB64CD3933FE08C FOREIGN KEY (ingredient_id) REFERENCES ingredient (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_ABB64CD39D32F035 FOREIGN KEY (action_id) REFERENCES "action" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO ingredient_action (ingredient_id, action_id) SELECT ingredient_id, action_id FROM __temp__ingredient_action');
        $this->addSql('DROP TABLE __temp__ingredient_action');
