 ...
 */
final class Version20220124133801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingredient ADD COLUMN mesure VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_5B37942C4A8CA2AD ON etape_ingredient (etape_id)');
        $this->addSql('CREATE INDEX IDX_5B37942C933FE08C ON etape_ingredient (ingredient_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__ingredient AS SELECT id, nom, article FROM ingredient');
        $this->addSql('DROP TABLE ingredient');
        $this->addSql('CREATE TABLE ingredient (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, article VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO ingredient (id, nom, article) SELECT id, nom, article FROM __temp__ingredient');
